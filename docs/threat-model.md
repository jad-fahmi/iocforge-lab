...
| Unsupported graph provenance | The history store requires provider-labeled relationships to link a matching evidence observation; unlinked manual relationships are recorded as analyst-created. |
